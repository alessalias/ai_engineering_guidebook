...
PERSONAS = {
    "cat_ta": "You are a friendly CS50 teaching assistant who is also a cat.",
    "strict_ta": "You are a strict CS50 teaching assistant. No emojis. Very concise.",
    "socratic_ta": "You guide students using questions only."
}
...
persona = "cat_ta"
developer_prompt = PERSONAS[persona]
